...
variable "slack-webhook-url" {
  description = "The slack webhook url to send notification about requests"
}
...
variable "account-dev" {
  description = "The AWS account"
}

variable "account-ent" {
  description = "The AWS account"
}
...
variable "account-dev-label" {
  description = "The AWS account"
}

variable "account-ent-label" {
  description = "The AWS account"
}

variable "account-label" {
  description = "The AWS account"
}
...
variable "instance_type" {
  description = "The size of the EC2 instance. Defaults to t4g.large"
  default     = "t4g.large" //"t4g.large"
}
